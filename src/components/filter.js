...
//     const { isOpen, setIsOpen, filterDrawer } = useContext(FilterContext);
...
//         <div className="bg-white">
            ...
            // <div>
                ...
                //                                 <Menu.Item key={item.category}>
                    ...
                    //             {products.map((item) => (
                    //                 <Disclosure as="div" key={item.id} className="border-b border-gray-200 py-6">
                    //                     {({ isOpen }) => (
                    //                         <>

...
//impor icons
import {BsPlus, BsEyeFill, BsEyeSlashFill} from 'react-icons/bs';
//import cart context
...
const Product = ({product}) => {
  ...
  return (
    <div>
      <div className = 'border border-[e4e4e4] h-[300px] h-[300px] mb-4 relative overflow-hidden group transition'>
